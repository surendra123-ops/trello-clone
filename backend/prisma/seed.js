...
async function main() {
  ...
  await prisma.cardLabel.createMany({
    data: [
      { cardId: card1.id, labelId: labels[4].id }, // Design
      { cardId: card2.id, labelId: labels[1].id }, // Feature
      { cardId: card3.id, labelId: labels[3].id }, // Documentation
      { cardId: card4.id, labelId: labels[1].id }, // Feature
      { cardId: card5.id, labelId: labels[0].id }, // Bug
      { cardId: card5.id, labelId: labels[5].id }, // Urgent
    ],
  });
